<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCustomerReview.aspx.cs" Inherits="TMV.BackEnd.Pages.EditCustomerReview" %>
...
<asp:content id="Content1" contentplaceholderid="placeHolderContent" runat="server">
    <div id="toolbar-box">
		...
		<div class="m">
			...
			<div class="header">Thêm mới/chỉnh sửa KHÁCH HÀNG ĐÁNH GIÁ</div>
			<div class="clr"></div>
		</div>
		<div class="b">
			<div class="b">
