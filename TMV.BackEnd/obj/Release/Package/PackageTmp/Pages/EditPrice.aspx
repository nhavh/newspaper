<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPrice.aspx.cs" Inherits="TMV.BackEnd.Pages.EditPrice" %>
...
<asp:content id="Content1" contentplaceholderid="placeHolderContent" runat="server">
    ...
    <div id="toolbar-box" style="width:770px;">
		...
		<div class="m">
			...
			<div class="header">Thêm mới/chỉnh sửa bảng giá
			</div>
			<div class="clr"></div>
		</div>
		<div class="b">
	...
	<div id="element-box" style="width:700px;">
			...
			<div class="m">
                <table class="adminform">
                    ...
                    <%--<tr>
                        <td>Sử&nbsp;dụng&nbsp;cho&nbsp;bản&nbsp;mobile:</td>
                        <td><asp:CheckBox id="cbIsMobile" runat="server" Width="100%" MaxLength="256"></asp:CheckBox></td>
                        <td></td>
                    </tr>--%>
                    <tr>
                        <td>Tiêu đề</td>
                    ...
                    <tr>
                        <td>Loại nội dung</td>
                        <td align="center"><asp:DropDownList id="ddlType" runat="server"></asp:DropDownList></td>
                        <td></td>
                    </tr>
                    <tr>
						<td style="width:20%">Hình&nbsp;bảng&nbsp;giá<br />(desktop:800xauto,mobile:320xauto)</td>
						<td>
    ...
    <script type="text/javascript">
        ...
        function uploadThumbnailAvatarSuccess(file, serverData) {
            try {
                ...
                var s = obj.image_handler + obj.filename.replace("~/Upload", "/img").replace(filename, "800_" + filename);
