<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCustomer.aspx.cs" Inherits="TMV.BackEnd.Pages.EditCustomer" %>
...
<asp:content id="Content1" contentplaceholderid="placeHolderContent" runat="server">
    <div id="toolbar-box">
		...
		<div class="m">
			...
			<div class="header">Thêm mới/chỉnh sửa KHÁCH HÀNG</div>
			<div class="clr"></div>
		</div>
		<div class="b">
			<div class="b">
			...
			<div class="admin-left">
                <table class="adminform">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><asp:TextBox id="txtFullName" runat="server" Width="95%"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Ngày hiển thị: </td>
                        <td>
        ...
        $(document).ready(function () {
            $("#<%= lbtSave.ClientID %>").click(function () {
                ...
                if (jQuery.trim($("#<%= txtFullName.ClientID %>").val()) == "") {
                    $("#ErorMessage").append("<br\>Mời nhập tên khách hàng");
                    rtnValue = false;
                }
                return rtnValue;
            });
    ...
    <script type="text/javascript">
        ...
        function uploadThumbnailAvatarSuccess(file, serverData) {
            try {
                ...
                var s = obj.image_handler + obj.filename.replace("~/Upload", "/image").replace(filename, "300_" + filename);
