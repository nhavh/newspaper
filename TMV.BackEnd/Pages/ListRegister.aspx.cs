...
{
    public partial class ListRegister : AdminPageBase
    {
        ...
        void GetGridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                var ctrl = new RegisterController();
                var info = new RegisterInfo();
                foreach (System.Reflection.PropertyInfo property in CBO.GetPropertyInfo(typeof(RegisterInfo)))
                {
