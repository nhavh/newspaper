<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListCustomerReview.aspx.cs" Inherits="TMV.BackEnd.Pages.ListCustomerReview" %>
...
<asp:content id="Content1" contentplaceholderid="placeHolderContent" runat="server">
    ...
    <div id="toolbar-box">
		...
		<div class="m">
					    ...
					    <tr>
						    <td id="toolbarAddRoom" class="button" runat="server">
							    <a href="<%=UrlAdd %>" class="modal">
								    <span title="Thêm đánh giá" class="icon-32-new"></span>THÊM ĐÁNH GIÁ
							    </a>
						    </td>
                            <td id="Td1">
			...
			<div class="header"> Đánh giá của <%=Title %>
			</div>
			<div class="clr"></div>
		</div>
		<div class="b">
