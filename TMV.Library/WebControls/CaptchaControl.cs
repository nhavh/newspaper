...
namespace TMV.WebControls
{
    ...
    public class CaptchaControl : WebControl, INamingContainer, IPostBackDataHandler
    {
        ...
        private const string CHARS_DEFAULT = "123456789";
        ...
        private Unit _CaptchaHeight = Unit.Pixel(18);
        private int _CaptchaLength = LENGTH_DEFAULT;
        private string _CaptchaText;
        private Unit _CaptchaWidth = Unit.Pixel(60);
        private string _ErrorMessage = "Mã bạn nhập không chính xác!<br />Vui lòng nhập lại mã bảo vệ!";
        private Style _ErrorStyle = new Style();        
        private int _Expiration = EXPIRATION_DEFAULT;

        private static string[] _FontFamilies = new string[] {"Verdana", "Tahoma", "Arial", "Comic Sans MS", "Courier New", "Georgia", "Lucida Console", "MS Sans Serif", "Times New Roman", "Stencil", "Trebuchet MS" };
        private System.Web.UI.WebControls.Image _image;
        private bool _IsValid = false;
        private static Random _Rand = new Random();
        private string _RenderUrl = RENDERURL_DEFAULT;
        private static string _Separator = ":-:";
        private string _Text = "Vui lòng nhập mã hiển thị ở hình trên:";
        ...
        private static Bitmap CreateImage(int width, int height)
        {
            ...
            Brush b = Brushes.WhiteSmoke;// new LinearGradientBrush(rect, Color.White, Color.WhiteSmoke, Convert.ToSingle(_Rand.NextDouble()) * 360, false);
        ...
        public static Bitmap GenerateImage(string encryptedText)
        {
            ...
            Bitmap bmp;
            Graphics g;
            HatchBrush hb = new HatchBrush(HatchStyle.LargeConfetti, Color.Black, Color.Black);
        ...
        private static FontFamily GetFont()
        {
            ...
            while (font == null)
            {
                try
                {
                    ...
                    font = new FontFamily(_FontFamilies[0]);
                }
                catch (Exception)
                {
                    font = null;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            writer.AddAttribute(HtmlTextWriterAttribute.Style, "margin-left:5px;border: solid 1px #8A8A8A;");
