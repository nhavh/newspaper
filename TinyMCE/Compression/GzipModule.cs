...
namespace Moxiecode.TinyMCE.Compression {
	...
	public class GzipModule : Moxiecode.TinyMCE.Web.IModule {
		...
		public void ProcessRequest(HttpContext context) {
            ...
            //string apath = (request.ApplicationPath.Equals("/") ? "" : request.ApplicationPath);
            //string ur = (request.Url.ToString().Replace(request.RawUrl,"") + apath + configSection.InstallPath.Replace("~", ""));
            string ur = configSection.InstallPath.Replace("~", "");
            gzipCompressor.AddData("var tinyMCEPreInit = {base : '" + ur + "', suffix : '" + suffix + "'};");
